<?php
    ...
    $query="INSERT into userRegistration(regNo,firstName,middleName,lastName,gender,contactNo,email,password,admin_id) values(?,?,?,?,?,?,?,?,?)";
    $stmt = $mysqli->prepare($query);
    $rc=$stmt->bind_param('sssssisss',$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$password,$admin_id);
    $stmt->execute();
