<?php
    ...
    $stmt=$mysqli->prepare("SELECT username,email,password,id FROM hostel_owner WHERE (userName=?|| email=?) and password=? ");
            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Hostel owner Login</h2>
