...
if (isset($_POST['submit'])) {
    ...
    if ($hostel_id == 0) {
        $error = "please choose a hostel";
    } else {
        $fees = $_POST['fee'];
        $sql = "SELECT room_no FROM rooms where room_no=? AND hostel_id=?";
        $stmt1 = $mysqli->prepare($sql);
        $stmt1->bind_param('ii', $roomno,$hostel_id);
        $stmt1->execute();
        $stmt1->store_result();
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-4">
                                        <select class="custom-select mr-sm-2" name="hostel_id" required="required">
                                            ...
                                            <?php
                                            $ret = "SELECT * from pm_hotel where `id`='$hostel_id';";
