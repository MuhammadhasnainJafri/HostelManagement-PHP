                    ...
                    <div class="room_main d-lg-flex flex-wrap align-items-start">
                        ...
                        <div class="room_main-cards col-lg-4">
                            <div class="room_main-cards_card">
                                ...
                                <button class="booking_btn btn theme-element theme-element--accent" type="submit"
                                onclick="window.location.href='registerroom.php?id=<?php 
                                echo $id;
                                ?>'"
                                >Book now</button>
